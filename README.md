...
- `lp_model_config.py` contains the settings about the network architecture (note: by modifying the network structure you will invalidate the trained weights available in this repository).
